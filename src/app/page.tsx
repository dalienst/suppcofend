    ...
    <div className="flex flex-col min-h-[calc(100vh-4rem)]">
      ...
      <section className="relative py-20 px-4 overflow-hidden bg-white border-b border-border">
        <div className=" mx-auto flex flex-col items-center text-center">
          <div className="inline-flex items-center gap-2 px-3 py-1 rounded-full bg-slate-100 text-slate-700 text-xs font-semibold uppercase tracking-wider mb-8">
        ...
        <div className=" mx-auto">
          <div className="grid grid-cols-1 md:grid-cols-3 gap-8">
            <div className="p-8 bg-white rounded-2xl border border-border shadow-sm">
              ...
              <h3 className="text-xl font-semibold text-slate-900 mb-3">For Contractors</h3>
            ...
            <div className="p-8 bg-white rounded-2xl border border-border shadow-sm">
              ...
              <h3 className="text-xl font-semibold text-slate-900 mb-3">For Suppliers</h3>
              <p className="text-slate-600">
            ...
            <div className="p-8 bg-white rounded-2xl border border-border shadow-sm">
              ...
              <h3 className="text-xl font-semibold text-slate-900 mb-3">Secure Operations</h3>
              <p className="text-slate-600">
