  ...
  return (
    <div className="min-h-screen flex items-center justify-center bg-slate-50 p-4">
      <div className="w-full max-w-4xl grid grid-cols-1 md:grid-cols-2 gap-8">
        ...
        >
          ...
          <div className="relative z-10 space-y-6">
            ...
            <div className="pt-6 flex items-center gap-2 text-jungle-700 font-bold">
        ...
        >
          ...
          <div className="relative z-10 space-y-6">
            ...
            <div className="pt-6 flex items-center gap-2 text-suppblue-700 font-bold">
      ...
      <div className="fixed bottom-8 left-1/2 -translate-x-1/2 flex items-center gap-2 opacity-50">
        ...
        <span className="text-xs font-bold tracking-widest text-slate-400 uppercase">SUPPCO Industrial</span>
      </div>
    </div>
  )
}
