    ...
    <div className="p-4 mx-auto space-y-8 animate-in fade-in-50 duration-300">
      ...
      {isLoading ? (
        ...
        <div className="bg-white border border-dashed border-slate-300 rounded-3xl p-12 text-center space-y-4 shadow-sm">
          ...
          <div>
            <h3 className="font-semibold text-slate-900 text-lg">No branches yet</h3>
          ...
          <button
            onClick={openModalForCreate}
            className="mt-4 text-suppblue-600 font-semibold hover:text-suppblue-700 text-sm inline-block"
          >
            + Create a branch
          </button>
        </div>
        ...
        <div className="bg-white rounded-3xl border border-slate-200 shadow-sm overflow-hidden flex flex-col">
                  ...
                  <tr key={branch.reference} className="hover:bg-slate-50/50 transition-colors group">
                    <td className="px-6 py-4">
                      <Link href={`/supplier/branches/${branch.reference}`} className="flex items-center gap-3 group/link hover:opacity-95">
                        ...
                        <span className="font-semibold text-slate-900 group-hover/link:text-suppblue-700 transition-colors flex items-center gap-1">
                          {branch.name}
          ...
          {!isLoading && paginatedBranches.length === 0 && (
            <div className="p-16 text-center space-y-4">
              ...
              <p className="text-slate-500 font-semibold">No physical branches match your search keyword.</p>
            </div>
          )}
          ...
          <div className="bg-white rounded-3xl shadow-xl w-full max-w-md overflow-hidden animate-in zoom-in-95 duration-200">
            ...
            <form onSubmit={handleSubmit(onSubmit)} className="p-6 space-y-5">
              <div className="space-y-2">
                <label className="text-sm font-semibold text-slate-700 ml-1">Branch Name <span className="text-red-500">*</span></label>
                <input
                  {...register("name")}
              ...
              <div className="space-y-2">
                <label className="text-sm font-semibold text-slate-700 ml-1">Physical Address</label>
                <textarea
                  {...register("address")}
                  rows={3}
      ...
      {deletingBranch && (
        <div className="fixed inset-0 z-50 flex items-center justify-center p-4 bg-slate-900/50 backdrop-blur-sm animate-in fade-in duration-200">
          <div className="bg-white rounded-3xl shadow-xl w-full max-w-sm overflow-hidden animate-in zoom-in-95 duration-200 p-6 text-center space-y-6">
            ...
            <div>
              <h2 className="font-semibold text-xl text-slate-900">Delete Branch?</h2>
