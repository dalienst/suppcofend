    ...
    <div className="p-4 container mx-auto space-y-8">
      ...
      <div className="flex flex-col sm:flex-row justify-between items-start sm:items-center gap-4">
        ...
        <button
          ...
          className="bg-suppblue-600 hover:bg-suppblue-700 text-white font-bold px-5 py-3 rounded-xl flex items-center gap-2 shadow-lg shadow-suppblue-600/20 transition-all"
        >
      ...
      {isLoading ? (
        ...
        <div className="text-center py-16 bg-white border border-slate-200 rounded-2xl p-8 space-y-4">
          ...
          <div className="space-y-1">
            <h3 className="font-bold text-slate-900 text-lg">No Payment Options</h3>
          ...
          <button
            onClick={openCreateModal}
            className="text-sm font-bold text-white bg-suppblue-600 hover:bg-suppblue-700 px-4 py-2.5 rounded-xl transition-all"
          >
        ...
        <div className="fixed inset-0 bg-slate-900/40 backdrop-blur-sm z-50 flex items-center justify-center p-4">
          <div className="bg-white rounded-2xl w-full max-w-lg border border-slate-100 shadow-2xl overflow-hidden flex flex-col max-h-[90vh]">
            ...
            <form onSubmit={handleSubmit(onSubmit)} className="p-6 space-y-5 overflow-y-auto flex-1">
              ...
              {/* Payment Type Choice */}
              <div className="space-y-1.5">
                <label className="text-sm font-bold text-slate-700">Payment Structure</label>
                <select
              ...
              {selectedPaymentType === "FLEXIBLE" && (
                <div className="grid grid-cols-2 gap-4 p-4 bg-slate-50 rounded-xl border border-slate-200">
                  <div className="space-y-1.5">
                    <label className="text-xs font-bold text-slate-700">Min Deposit (%)</label>
                    <input
                      type="number"
                      step="0.01"
              ...
              <div className="flex items-center justify-between p-3 bg-slate-50 border border-slate-200 rounded-xl">
                <div>
                  <p className="text-sm font-bold text-slate-800">Is Policy Active?</p>
              ...
              <div className="flex justify-end gap-3 pt-4 border-t border-slate-100">
                ...
                <button
                  ...
                  className="px-5 py-2.5 bg-suppblue-600 hover:bg-suppblue-700 text-white rounded-xl text-sm font-bold flex items-center gap-2 transition-all disabled:opacity-50"
                >
