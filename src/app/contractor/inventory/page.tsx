...
export default function ContractorInventoryPage() {
  ...
  const saveMutation = useMutation({
    ...
    onSuccess: () => {
      queryClient.invalidateQueries({ queryKey: ["contractor-inventory"] })
      closeModal()
    },
  })
            ...
            <table className="w-full text-left text-sm">
              <thead className="bg-slate-50/50 border-b border-slate-100 text-slate-500 font-bold uppercase tracking-wider text-xs">
                <tr>
                  ...
                  <th className="px-6 py-4">Hierarchy Layers</th>
                  ...
                  >
                    <td className="px-6 py-4">
                      <div className="flex items-center gap-3">
                        <div className="w-10 h-10 bg-jungle-50 text-jungle-600 rounded-xl flex items-center justify-center shrink-0 group-hover:bg-jungle-600 group-hover:text-white transition-colors">
                    ...
                    <td className="px-6 py-4">
                      <div className="flex items-center gap-1.5 text-slate-600">
                        ...
                        <span className="font-medium">{inv.layers?.length || 0} Layers Mapped</span>
                      </div>
                    </td>
            ...
            <form onSubmit={handleSubmit(onSubmit)} className="p-6 space-y-5">
              <div className="space-y-2">
                ...
                <input
                  ...
                  placeholder="e.g. Block A Construction Store"
                />
              ...
              <div className="space-y-2">
                ...
                <textarea
                  ...
                  placeholder="e.g. Primary site storage tracking"
                />
              </div>
